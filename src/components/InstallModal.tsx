        ...
        <div className="px-6 py-5 space-y-5">
          ...
          {client === 'code' && (
            <>
              ...
              <div className="bg-gray-50 rounded-xl p-3.5 text-xs text-gray-600 space-y-1.5">
                <p className="font-semibold text-gray-700">등록 확인</p>
                <div className="relative">
                  <pre className="bg-gray-900 text-green-400 text-xs rounded-xl p-3 font-mono">
                    {`claude mcp list`}
                  </pre>
              ...
              <div className="text-xs text-gray-500 bg-gray-50 rounded-xl p-3 space-y-2">
                ...
                <div className="space-y-1">
                  ...
                  <p><code className="bg-white border border-gray-200 px-1.5 rounded">--scope project</code> 현재 프로젝트에서만 사용 <span className="text-gray-400">(.claude/settings.json)</span></p>
                </div>
              </div>
            </>
          )}
            ...
            <>
              <div className="flex items-start gap-3 bg-emerald-50 border border-emerald-200 rounded-xl p-3.5">
                ...
                <div className="text-xs text-emerald-800 leading-relaxed">
                  ...
                  <p>Claude.ai 웹에서는 로컬 npx 서버 대신 <strong>원격 MCP 서버(HTTPS URL)</strong>를 UI에서 직접 등록합니다. Pro·Team·Enterprise 플랜 필요.</p>
                </div>
              </div>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-3.5 text-xs text-amber-800">
                ...
                <p>Claude.ai 웹의 MCP 연결은 <strong>원격 서버</strong>를 통하므로, 로컬 PC의 파일이나 앱에 직접 접근이 필요한 서버는 Claude Desktop 또는 Claude Code를 사용하세요.</p>
              </div>
            </>
          )}
